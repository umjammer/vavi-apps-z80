package konamiman.InstructionsExecution.Core;
...
/**
 * Default implementation of {@link IZ80InstructionExecutor}
 */
public class Z80InstructionExecutor implements IZ80InstructionExecutor {

    private IZ80Registers registers;

    private IZ80ProcessorAgent processorAgent; public IZ80ProcessorAgent getProcessorAgent() { return processorAgent; } public void setProcessorAgent(IZ80ProcessorAgent value) { processorAgent = value; }
    ...
    private int execute_CB_Instruction() {
        Inc_R();
        Inc_R();
        return CB_InstructionExecutors[processorAgent.fetchNextOpcode()].get();
    }
    ...
    private int execute_SingleByte_Instruction(byte firstOpcodeByte)    {
        Inc_R();
        return SingleByte_InstructionExecutors[firstOpcodeByte].get();
    }
...
//#region Auxiliary methods
    ...
    private void fetchFinished(boolean isRet/*= false*/, boolean isHalt/*= false*/, boolean isLdSp/*= false*/, boolean isEiOrDi/*= false*/)    {
        ...
        {{
            setIsRetInstruction(isRet);
            setIsHaltInstruction(isHalt);
            setIsLdSpInstruction(isLdSp);
            setIsEiOrDiInstruction(isEiOrDi);
        }});
    }
...
//#endregion
    ...
    private int execute_DD_Instruction() {
        ...
        if((secondOpcodeByte & 0xff) == 0xCB)
        {
            ...
            return DDCB_InstructionExecutors[processorAgent.fetchNextOpcode()].apply(offset);
        }
    ...
    private int execute_FD_Instruction() {
        ...
        if((secondOpcodeByte & 0xff) == 0xCB)
        {
            ...
            processorAgent.fetchNextOpcode();
            var offset = processorAgent.fetchNextOpcode();
            return FDCB_InstructionExecutors[processorAgent.fetchNextOpcode()].apply(offset);
        }
    ...
    private void initialize_DD_InstructionsTable() {
        DD_InstructionExecutors = new HashMap<>() {{
            put((byte) 0x09, Z80InstructionExecutor.this::ADD_IX_BC);
            put((byte) 0x19, Z80InstructionExecutor.this::ADD_IX_DE);
            put((byte) 0x21, Z80InstructionExecutor.this::LD_IX_nn);
            put((byte) 0x22, Z80InstructionExecutor.this::LD_aa_IX);
            put((byte) 0x23, Z80InstructionExecutor.this::INC_IX);
            put((byte) 0x24, Z80InstructionExecutor.this::INC_IXH);
            put((byte) 0x25, Z80InstructionExecutor.this::DEC_IXH);
            put((byte) 0x26, Z80InstructionExecutor.this::LD_IXH_n);
            put((byte) 0x29, Z80InstructionExecutor.this::ADD_IX_IX);
            put((byte) 0x2A, Z80InstructionExecutor.this::LD_IX_aa);
            put((byte) 0x2B, Z80InstructionExecutor.this::DEC_IX);
            put((byte) 0x2C, Z80InstructionExecutor.this::INC_IXL);
            put((byte) 0x2D, Z80InstructionExecutor.this::DEC_IXL);
            put((byte) 0x2E, Z80InstructionExecutor.this::LD_IXL_n);
            put((byte) 0x34, Z80InstructionExecutor.this::INC_aIX_plus_n);
            put((byte) 0x35, Z80InstructionExecutor.this::DEC_aIX_plus_n);
            put((byte) 0x36, Z80InstructionExecutor.this::LD_aIX_plus_n_N);
            put((byte) 0x39, Z80InstructionExecutor.this::ADD_IX_SP);
            put((byte) 0x44, Z80InstructionExecutor.this::LD_B_IXH);
            put((byte) 0x45, Z80InstructionExecutor.this::LD_B_IXL);
            put((byte) 0x46, Z80InstructionExecutor.this::LD_B_aIX_plus_n);
            put((byte) 0x4C, Z80InstructionExecutor.this::LD_C_IXH);
            put((byte) 0x4D, Z80InstructionExecutor.this::LD_C_IXL);
            put((byte) 0x4E, Z80InstructionExecutor.this::LD_C_aIX_plus_n);
            put((byte) 0x54, Z80InstructionExecutor.this::LD_D_IXH);
            put((byte) 0x55, Z80InstructionExecutor.this::LD_D_IXL);
            put((byte) 0x56, Z80InstructionExecutor.this::LD_D_aIX_plus_n);
            put((byte) 0x5C, Z80InstructionExecutor.this::LD_E_IXH);
            put((byte) 0x5D, Z80InstructionExecutor.this::LD_E_IXL);
            put((byte) 0x5E, Z80InstructionExecutor.this::LD_E_aIX_plus_n);
            put((byte) 0x60, Z80InstructionExecutor.this::LD_IXH_B);
            put((byte) 0x61, Z80InstructionExecutor.this::LD_IXH_C);
            put((byte) 0x62, Z80InstructionExecutor.this::LD_IXH_D);
            put((byte) 0x63, Z80InstructionExecutor.this::LD_IXH_E);
            put((byte) 0x64, Z80InstructionExecutor.this::LD_IXH_IXH);
            put((byte) 0x65, Z80InstructionExecutor.this::LD_IXH_IXL);
            put((byte) 0x66, Z80InstructionExecutor.this::LD_H_aIX_plus_n);
            put((byte) 0x67, Z80InstructionExecutor.this::LD_IXH_A);
            put((byte) 0x68, Z80InstructionExecutor.this::LD_IXL_B);
            put((byte) 0x69, Z80InstructionExecutor.this::LD_IXL_C);
            put((byte) 0x6A, Z80InstructionExecutor.this::LD_IXL_D);
            put((byte) 0x6B, Z80InstructionExecutor.this::LD_IXL_E);
            put((byte) 0x6C, Z80InstructionExecutor.this::LD_IXL_H);
            put((byte) 0x6D, Z80InstructionExecutor.this::LD_IXL_IXL);
            put((byte) 0x6E, Z80InstructionExecutor.this::LD_L_aIX_plus_n);
            put((byte) 0x6F, Z80InstructionExecutor.this::LD_IXL_A);
            put((byte) 0x70, Z80InstructionExecutor.this::LD_aIX_plus_n_B);
            put((byte) 0x71, Z80InstructionExecutor.this::LD_aIX_plus_n_C);
            put((byte) 0x72, Z80InstructionExecutor.this::LD_aIX_plus_n_D);
            put((byte) 0x73, Z80InstructionExecutor.this::LD_aIX_plus_n_E);
            put((byte) 0x74, Z80InstructionExecutor.this::LD_aIX_plus_n_H);
            put((byte) 0x75, Z80InstructionExecutor.this::LD_aIX_plus_n_L);
            put((byte) 0x77, Z80InstructionExecutor.this::LD_aIX_plus_n_A);
            put((byte) 0x7C, Z80InstructionExecutor.this::LD_A_IXH);
            put((byte) 0x7D, Z80InstructionExecutor.this::LD_A_IXL);
            put((byte) 0x7E, Z80InstructionExecutor.this::LD_A_aIX_plus_n);
            put((byte) 0x84, Z80InstructionExecutor.this::ADD_A_IXH);
            put((byte) 0x85, Z80InstructionExecutor.this::ADD_A_IXL);
            put((byte) 0x86, Z80InstructionExecutor.this::ADD_A_aIX_plus_n);
            put((byte) 0x8C, Z80InstructionExecutor.this::ADC_A_IXH);
            put((byte) 0x8D, Z80InstructionExecutor.this::ADC_A_IXL);
            put((byte) 0x8E, Z80InstructionExecutor.this::ADC_A_aIX_plus_n);
            put((byte) 0x94, Z80InstructionExecutor.this::SUB_IXH);
            put((byte) 0x95, Z80InstructionExecutor.this::SUB_IXL);
            put((byte) 0x96, Z80InstructionExecutor.this::SUB_aIX_plus_n);
            put((byte) 0x9C, Z80InstructionExecutor.this::SBC_A_IXH);
            put((byte) 0x9D, Z80InstructionExecutor.this::SBC_A_IXL);
            put((byte) 0x9E, Z80InstructionExecutor.this::SBC_A_aIX_plus_n);
            put((byte) 0xA4, Z80InstructionExecutor.this::AND_IXH);
            put((byte) 0xA5, Z80InstructionExecutor.this::AND_IXL);
            put((byte) 0xA6, Z80InstructionExecutor.this::AND_aIX_plus_n);
            put((byte) 0xAC, Z80InstructionExecutor.this::XOR_IXH);
            put((byte) 0xAD, Z80InstructionExecutor.this::XOR_IXL);
            put((byte) 0xAE, Z80InstructionExecutor.this::XOR_aIX_plus_n);
            put((byte) 0xB4, Z80InstructionExecutor.this::OR_IXH);
            put((byte) 0xB5, Z80InstructionExecutor.this::OR_IXL);
            put((byte) 0xB6, Z80InstructionExecutor.this::OR_aIX_plus_n);
            put((byte) 0xBC, Z80InstructionExecutor.this::CP_IXH);
            put((byte) 0xBD, Z80InstructionExecutor.this::CP_IXL);
            put((byte) 0xBE, Z80InstructionExecutor.this::CP_aIX_plus_n);
            put((byte) 0xE1, Z80InstructionExecutor.this::POP_IX);
            put((byte) 0xE3, Z80InstructionExecutor.this::EX_aSP_IX);
            put((byte) 0xE5, Z80InstructionExecutor.this::PUSH_IX);
            put((byte) 0xE9, Z80InstructionExecutor.this::JP_aIX);
            put((byte) 0xF9, Z80InstructionExecutor.this::LD_SP_IX);
        }};
    }
    ...
    private void initialize_FD_InstructionsTable() {
        FD_InstructionExecutors = new HashMap<>() {{
            put((byte) 0x09, Z80InstructionExecutor.this::ADD_IY_BC);
            put((byte) 0x19, Z80InstructionExecutor.this::ADD_IY_DE);
            put((byte) 0x21, Z80InstructionExecutor.this::LD_IY_nn);
            put((byte) 0x22, Z80InstructionExecutor.this::LD_aa_IY);
            put((byte) 0x23, Z80InstructionExecutor.this::INC_IY);
            put((byte) 0x24, Z80InstructionExecutor.this::INC_IYH);
            put((byte) 0x25, Z80InstructionExecutor.this::DEC_IYH);
            put((byte) 0x26, Z80InstructionExecutor.this::LD_IYH_n);
            put((byte) 0x29, Z80InstructionExecutor.this::ADD_IY_IY);
            put((byte) 0x2A, Z80InstructionExecutor.this::LD_IY_aa);
            put((byte) 0x2B, Z80InstructionExecutor.this::DEC_IY);
            put((byte) 0x2C, Z80InstructionExecutor.this::INC_IYL);
            put((byte) 0x2D, Z80InstructionExecutor.this::DEC_IYL);
            put((byte) 0x2E, Z80InstructionExecutor.this::LD_IYL_n);
            put((byte) 0x34, Z80InstructionExecutor.this::INC_aIY_plus_n);
            put((byte) 0x35, Z80InstructionExecutor.this::DEC_aIY_plus_n);
            put((byte) 0x36, Z80InstructionExecutor.this::LD_aIY_plus_n_N);
            put((byte) 0x39, Z80InstructionExecutor.this::ADD_IY_SP);
            put((byte) 0x44, Z80InstructionExecutor.this::LD_B_IYH);
            put((byte) 0x45, Z80InstructionExecutor.this::LD_B_IYL);
            put((byte) 0x46, Z80InstructionExecutor.this::LD_B_aIY_plus_n);
            put((byte) 0x4C, Z80InstructionExecutor.this::LD_C_IYH);
            put((byte) 0x4D, Z80InstructionExecutor.this::LD_C_IYL);
            put((byte) 0x4E, Z80InstructionExecutor.this::LD_C_aIY_plus_n);
            put((byte) 0x54, Z80InstructionExecutor.this::LD_D_IYH);
            put((byte) 0x55, Z80InstructionExecutor.this::LD_D_IYL);
            put((byte) 0x56, Z80InstructionExecutor.this::LD_D_aIY_plus_n);
            put((byte) 0x5C, Z80InstructionExecutor.this::LD_E_IYH);
            put((byte) 0x5D, Z80InstructionExecutor.this::LD_E_IYL);
            put((byte) 0x5E, Z80InstructionExecutor.this::LD_E_aIY_plus_n);
            put((byte) 0x60, Z80InstructionExecutor.this::LD_IYH_B);
            put((byte) 0x61, Z80InstructionExecutor.this::LD_IYH_C);
            put((byte) 0x62, Z80InstructionExecutor.this::LD_IYH_D);
            put((byte) 0x63, Z80InstructionExecutor.this::LD_IYH_E);
            put((byte) 0x64, Z80InstructionExecutor.this::LD_IYH_IYH);
            put((byte) 0x65, Z80InstructionExecutor.this::LD_IYH_IYL);
            put((byte) 0x66, Z80InstructionExecutor.this::LD_H_aIY_plus_n);
            put((byte) 0x67, Z80InstructionExecutor.this::LD_IYH_A);
            put((byte) 0x68, Z80InstructionExecutor.this::LD_IYL_B);
            put((byte) 0x69, Z80InstructionExecutor.this::LD_IYL_C);
            put((byte) 0x6A, Z80InstructionExecutor.this::LD_IYL_D);
            put((byte) 0x6B, Z80InstructionExecutor.this::LD_IYL_E);
            put((byte) 0x6C, Z80InstructionExecutor.this::LD_IYL_H);
            put((byte) 0x6D, Z80InstructionExecutor.this::LD_IYL_IYL);
            put((byte) 0x6E, Z80InstructionExecutor.this::LD_L_aIY_plus_n);
            put((byte) 0x6F, Z80InstructionExecutor.this::LD_IYL_A);
            put((byte) 0x70, Z80InstructionExecutor.this::LD_aIY_plus_n_B);
            put((byte) 0x71, Z80InstructionExecutor.this::LD_aIY_plus_n_C);
            put((byte) 0x72, Z80InstructionExecutor.this::LD_aIY_plus_n_D);
            put((byte) 0x73, Z80InstructionExecutor.this::LD_aIY_plus_n_E);
            put((byte) 0x74, Z80InstructionExecutor.this::LD_aIY_plus_n_H);
            put((byte) 0x75, Z80InstructionExecutor.this::LD_aIY_plus_n_L);
            put((byte) 0x77, Z80InstructionExecutor.this::LD_aIY_plus_n_A);
            put((byte) 0x7C, Z80InstructionExecutor.this::LD_A_IYH);
            put((byte) 0x7D, Z80InstructionExecutor.this::LD_A_IYL);
            put((byte) 0x7E, Z80InstructionExecutor.this::LD_A_aIY_plus_n);
            put((byte) 0x84, Z80InstructionExecutor.this::ADD_A_IYH);
            put((byte) 0x85, Z80InstructionExecutor.this::ADD_A_IYL);
            put((byte) 0x86, Z80InstructionExecutor.this::ADD_A_aIY_plus_n);
            put((byte) 0x8C, Z80InstructionExecutor.this::ADC_A_IYH);
            put((byte) 0x8D, Z80InstructionExecutor.this::ADC_A_IYL);
            put((byte) 0x8E, Z80InstructionExecutor.this::ADC_A_aIY_plus_n);
            put((byte) 0x94, Z80InstructionExecutor.this::SUB_IYH);
            put((byte) 0x95, Z80InstructionExecutor.this::SUB_IYL);
            put((byte) 0x96, Z80InstructionExecutor.this::SUB_aIY_plus_n);
            put((byte) 0x9C, Z80InstructionExecutor.this::SBC_A_IYH);
            put((byte) 0x9D, Z80InstructionExecutor.this::SBC_A_IYL);
            put((byte) 0x9E, Z80InstructionExecutor.this::SBC_A_aIY_plus_n);
            put((byte) 0xA4, Z80InstructionExecutor.this::AND_IYH);
            put((byte) 0xA5, Z80InstructionExecutor.this::AND_IYL);
            put((byte) 0xA6, Z80InstructionExecutor.this::AND_aIY_plus_n);
            put((byte) 0xAC, Z80InstructionExecutor.this::XOR_IYH);
            put((byte) 0xAD, Z80InstructionExecutor.this::XOR_IYL);
            put((byte) 0xAE, Z80InstructionExecutor.this::XOR_aIY_plus_n);
            put((byte) 0xB4, Z80InstructionExecutor.this::OR_IYH);
            put((byte) 0xB5, Z80InstructionExecutor.this::OR_IYL);
            put((byte) 0xB6, Z80InstructionExecutor.this::OR_aIY_plus_n);
            put((byte) 0xBC, Z80InstructionExecutor.this::CP_IYH);
            put((byte) 0xBD, Z80InstructionExecutor.this::CP_IYL);
            put((byte) 0xBE, Z80InstructionExecutor.this::CP_aIY_plus_n);
            put((byte) 0xE1, Z80InstructionExecutor.this::POP_IY);
            put((byte) 0xE3, Z80InstructionExecutor.this::EX_aSP_IY);
            put((byte) 0xE5, Z80InstructionExecutor.this::PUSH_IY);
            put((byte) 0xE9, Z80InstructionExecutor.this::JP_aIY);
            put((byte) 0xF9, Z80InstructionExecutor.this::LD_SP_IY);
        }};
    }
    ...
    byte ADC_HL_BC()
    {
        ...
        var newValueInt = oldValue + valueToAdd + registers.getCF().intValue();
    ...
    private byte ADC_A_A()
    {
        ...
        var newValueInt = (int)oldValue + (valueToAdd + registers.getCF().intValue());
    ...
    private byte CPI()
    {
        ...
        registers.setNF(Bit.ON);
        var valueForFlags3And5 = (byte)(newValue - registers.getHF().intValue());
    ...
    private byte CPIR()
    {
        ...
        if(counter != 0 && !registers.getZF().booleanValue()) {
    ...
    private byte ADC_A_aIX_plus_n()
    {
        ...
        var oldValue = registers.getA();
        var address = (short)(registers.getIX() + offset);
        var valueToAdd = processorAgent.readFromMemory(address);
        var newValueInt = (int)oldValue + (valueToAdd + registers.getCF().intValue());
        var newValue = (byte)(newValueInt & 0xFF);
        registers.setA(newValue);
    ...
    private byte ADC_A_aIY_plus_n()
    {
        ...
        var oldValue = registers.getA();
        var address = (short)(registers.getIY() + offset);
        var valueToAdd = processorAgent.readFromMemory(address);
        var newValueInt = (int)oldValue + (valueToAdd + registers.getCF().intValue());
        var newValue = (byte)(newValueInt & 0xFF);
        registers.setA(newValue);
    ...
    private byte AND_A()
    {
        ...
        registers.setPF(parity[newValue]);
        registers.setNF(Bit.OFF);
    ...
    byte BIT_7_aIY_plus_n(byte offset)
    {
        ...
        byte DAA()
        {
            ...
            if (registers.getHF().booleanValue() || (oldValue & 0x0F) > 9) newValue = (byte)(newValue + (registers.getNF().booleanValue() ? -0x06 : 0x06)); //FA
            if (registers.getCF().booleanValue() || (oldValue & 0xff) > 0x99) newValue = (byte)(newValue + (registers.getNF().booleanValue() ? -0x60 : 0x60)); //A0
    ...
    private byte IM_0()
    {
        ...
        processorAgent.SetInterruptMode((byte) 0);
    ...
    private byte IM_1()
    {
        ...
        processorAgent.SetInterruptMode((byte) 1);
    ...
    private byte IM_2()
    {
        ...
        processorAgent.SetInterruptMode((byte) 2);
    ...
    private byte INC_aIY_plus_n()
    {
        ...
        registers.setZF(Bit.of((newValue == 0)));
        registers.setHF(Bit.of(((newValue & 0x0F) == 0x00)));
        registers.setPF(Bit.of((((newValue & 0xff) & 0xff) == 0x80)));
        registers.setNF(Bit.OFF);
        setFlags3and5From(newValue);
    ...
    private byte POP_AF()
    {
        ...
        var newAF = NumberUtils.createShort(
                ...
                processorAgent.readFromMemory((short)(sp + 1)));
    ...
    byte RL_A()
    {
        ...
        var oldValue = registers.getA();
        var newValue = (byte)((oldValue << 1) | (byte) registers.getCF().intValue());
        registers.setA(newValue);
    ...
    byte RR_A()
    {
        ...
        var oldValue = registers.getA();
        var newValue = (byte)((oldValue >> 1) | (registers.getCF().booleanValue() ? 0x80 : 0));
        registers.setA(newValue);
    ...
    byte RRD()
    {
        ...
        registers.setHF(Bit.OFF);
        registers.setPF(parity[newAvalue]);
        registers.setNF(Bit.OFF);
